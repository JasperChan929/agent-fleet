...
Explicit task IDs are checked against the pinned checkout before the worker
image is built or a result directory is created. Any unknown IDs fail together.
